...
declare module '$env/static/private' {
	...
	export const GHOSTTY_SHELL_INTEGRATION_NO_TITLE: string;
	...
	export const FXF_ALT_C_OPTS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		MANPATH: string;
		GHOSTTY_SHELL_INTEGRATION_NO_TITLE: string;
		__MISE_DIFF: string;
